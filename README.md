...
![Build](https://github.com/mahmudurrahman/TestAndroidApp/workflows/Pre%20Merge%20Checks/badge.svg)
...
- [ ] Choose a [LICENSE](https://github.com/mahmudurrahman/TestAndroidApp/community/license/new?branch=master).
- [ ] Set your `ORG_GRADLE_PROJECT_NEXUS_USERNAME`, `ORG_GRADLE_PROJECT_NEXUS_PASSWORD`, `ORG_GRADLE_PROJECT_SIGNING_KEY` and `ORG_GRADLE_PROJECT_SIGNING_PWD` secrets in [Settings](https://github.com/mahmudurrahman/TestAndroidApp/settings/secrets/actions).
